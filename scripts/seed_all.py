...
from core.models import CustomUser, ClassGroup, StudentEnrollment, School
...
print(f"  🏛️  لجنة الجودة:          {QualityCommitteeMember.objects.filter(school=school).count()} عضو")
print("═" * 60)
print("\n── بيانات الدخول ─────────────────────────────────────")
