...
# نوع الزيارة: إشرافية (مشرف يقيّم معلّماً)، أو ذاتية (المعلّم يقيّم نفسه)،
# أو تبادل زيارات (معلّمٌ يزور زميله)
OBSERVATION_KIND = [
    ("supervision", "زيارة إشرافية"),
    ("self", "تقييم ذاتي"),
    # تبادل الزيارات: معلّمٌ يزور زميله. لا إشرافَ فيها ولا تقييمَ من أعلى —
    # وهي ركنٌ في التطوير المهنيّ المدرسيّ، وكانت الوحدة تخلو منها فلا يجد
    # المعلّم إلّا أن يُقيّم نفسه.
    ("peer", "زيارة زميل"),
]
