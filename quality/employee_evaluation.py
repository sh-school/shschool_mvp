...
class EmployeeEvaluation(models.Model):
    ...
    employee      = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="evaluations",
                                      verbose_name="الموظف")
    evaluator     = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="evaluations_given",
    ...
    def completion_rate(self):
        ...
        total_staff = Membership.objects.filter(
            ...
            role__name__in=["teacher", "coordinator", "specialist", "nurse",
                            "librarian", "bus_supervisor", "admin",
                            "vice_admin", "vice_academic"],
        ).count()
