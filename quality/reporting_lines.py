...
الأنشطة، والأخصائيّ، ومساعدُ المعلّم…) لا خطَّ تبعيّةٍ له فيه — فيبقى الوضعُ لمن تجيزه
`_require_evaluator` (المدير والنائبان) حتى يُحسم (ADR-0002 §6.6 بند 9).

والمديرُ يضع لأيّ موظّف: هو رأسُ الهرم ومعتمِدُ كلّ تقرير، والمصدرُ لا يمنعه ولا يجيزه صراحةً
لمن ليس مرؤوسَه المباشر.
"""
