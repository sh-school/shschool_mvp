...
class AppraisalYearFacts:
    ...
    #: المدارس.pdf» ص22) ولم تُجدَّد، تقدّم لتجديدها أم لم يتقدّم: النصُّ على وقوع التجديد لا
    #: على طلبه. ولا يُعدّ هنا من نصّت السياسةُ على أنّه «لن يفقد» رخصتَه: النائبُ الذي تقدّم
    #: للتجديد ولم يستوفِ شروطه (ص23 بند 1)، ومن تقدّم لمستوىً أعلى ولم يُمنحه (ص22 بند 4).
    #: أمّا «لم يحصل عليها» فمهلتُها نهاية 2029-2030 (ص7) فلا أثرَ لها على تقييم 2026-2027.
