...
| **التنقّلُ بتبديل المحتوى** | `test_page_nav_callables`، `test_page_nav_htmx_process` | كلُّ دالّةٍ في قائمة `CALLABLE` (`actions.js`) تُسنَد إلى `window` في القالب لا تُعلَن مجرّدةً — `page-nav.js` يغلّف سكربتَ الصفحة فيضيع الإعلانُ المجرّد (قائمةُ الجداول 2026-09-22)؛ وHTMX يُعاد ربطُه بعد التبديل |
