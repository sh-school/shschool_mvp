...
| **المنطقةُ الآمنة (H-04)** | `test_safe_area_tokens` | لا `env(safe-area-inset-*)` خارجَ تعريف `--safe-top/--safe-bottom/--safe-inline` في `10-foundation.css` (كلٌّ مرّةً واحدةً بمحتاطٍ `0px`)؛ والشريطُ السفليّ وشريطُ التثبيت والترويسةُ والتوستُ والرسائلُ وشريطُ الرجوع تقرؤها |
