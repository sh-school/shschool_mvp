...
|---|---|---|
| **بنيةُ CSS** | `test_css_split`، `test_css_layers` | قائمةُ الملفّات = القرص؛ جملةُ الطبقات في أوّل ملفّ؛ **لا قاعدةَ خارجَ `@layer`**؛ كلُّ ملفٍّ على حدّ طبقته؛ لا `url()` نسبيٌّ مكسور؛ كلُّ قواعد `html.dark` في `themes` |
