...
| **التطبيقُ المثبَّت واللمس (Q-12، Q-08)** | `test_pwa_manifest_and_touch` | المانيفستان `standalone` بـ`id` ثابتٍ مختلفٍ ولا `orientation`؛ `touch-action: manipulation` على التحكّمات؛ `aria-current` لعنصر الشريط السفليّ الحاليّ |
