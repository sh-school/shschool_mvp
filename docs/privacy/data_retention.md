...
| `staff_affairs_attendanceexception` | استثناءاتُ التأخير الصباحيّ والخروج المبكر (نموذج 03): المدّةُ والساعةُ ومحتوى الطلب ومرفقُ ما يثبت الحاجة (ملفٌّ قد يكون تقريراً طبيّاً — يُخدَم لصاحبه وللمدير ونائب الشؤون الإدارية وحدَهم) ووصفُه الاختياريّ وتغذيةُ المدير الراجعة — سندُ ما لم يُعدّ تأخّراً أو انصرافاً مبكراً |
