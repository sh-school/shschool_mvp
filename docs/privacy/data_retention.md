...
| `staff_affairs_principaldelegation` | إنابةُ المدير نائبَ الشؤون الإدارية ليومٍ (بطاقة نائب الشؤون الإدارية: «الإنابة عن المدير في مهامه في حال غيابه») — من أُنيب ومن كتبها، ومتى رُفعت ومن رفعها: الرفعُ لا يحذف الصفّ، وقراراتُ الإنابة تشير إلى معرّفه، فيبقى من اعتمد باسم المدير ومتى |
