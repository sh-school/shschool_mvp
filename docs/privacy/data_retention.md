...
**ملفّاتُ التصدير المؤقّتة**: تصديرُ الجدول (PDF/Excel) صار خلفيّاً (البند 5، §4.4:
`core_exportjob`) — محتواه لا يُبثّ مباشرةً في الردّ بل يُخزَّن حتى يجهز، فيُحذف **الصفُّ كلُّه** (كلُّ الحالات: جاهزٌ وفاشلٌ وقيد التحضير) بعد 24 ساعةً من إنشائه كحدٍّ صلبٍ، بمهمّةٍ خاصّةٍ تجري
**كلَّ ساعة** (VI-30ب، 2026-09-26؛ كانت يوميّةً فأسوأُ حالةٍ ≈ 48 ساعة) لا بقاعدة N-يوم هنا. والآليّةُ مركزيّةٌ (`core/exports`)
لكلّ تصديرٍ خلفيّ يُسجَّل في سجلّ الأنواع. وما سواه من تصديرٍ (Excel/PDF مباشر في مسارات
أخرى) لا يزال يُبثّ في الردّ ولا يُحفظ، و`core_storedfile` يحمل المرفوعاتِ (أعذاراً، أدلّةً،
خطَّ PDF) لا مخرجاتٍ مؤقّتة. فلا قاعدةَ N-يوم لأيٍّ منهما هنا.
...
| `core_capabilitygrant` | منحُ القدرات المفوَّضة باسم مستخدمٍ (مُشغِّل الجدول) وسحبُها: من ولمن ومتى ولِمَ — أثرُ صلاحيّاتٍ يُحفظ؛ والسحبُ يُعلَّم ولا يُمسح (`revoked_at`)، وكلُّ منحٍ وسحبٍ في السجلَّين أعلاه أيضاً. |
...
| `staff_affairs_staffattendance` | حضورُ الموظّف اليوميّ: الحالةُ ووقتا الحضور والانصراف ودقائقُ التأخّر والانصراف المبكر والإذن، ونوعُ يوم الغياب والعذرُ المقبول ومن قبِله ومتى (المديرُ أو من ينوب عنه بتكليفه أو مسؤولُه المباشر: النائبُ الإداريّ للإداريّين والأكاديميّ للأكاديميّين) — سندُ الخصم (سياسة الحضور ت/د 2027/01، البنود 2.4 و5.1–5.3). والعذرُ نصٌّ حرٌّ قصير قد يحمل بيانةً صحّيّة (فئةٌ خاصّة — PDPPL م.16): يُعرض نصُّه ويُكتب للمدير ومن ينوب عنه وحدَهما، ويرى من يرصد الوقتَ أنّ عذراً قُبل فقط، ولا يُكتب نصُّه في سجلّ التدقيق (قيمةٌ منطقيّة) فيُمحى بمحو سجلّ اليوم |
| `staff_affairs_permitrequest` | طلباتُ الأذونات القصيرة واعتمادُها (نموذج 02): النوعُ والنافذةُ وسببُ الطلب (نصٌّ حرٌّ حتى 500 حرف قد يحمل بيانةً صحّيّة — PDPPL م.16؛ يطّلع عليه صاحبُه وأصحابُ مربّعات طلبه وحدَهم كما في الورقة، ولا يُكتب في سجلّ التدقيق ولا في التقرير الشهريّ) وتوقيعاتُ المربّعات (السكرتارية ومنسّقُ المادّة والمسؤولُ المباشر والمدير) وعلامةُ «يجاوز الحدّ» ومرجعُ الموافقة الكتابيّة لما جاوز 3 ساعات أو 10 في الشهر (كتابٌ أو بريدٌ وتاريخُه — بلا نصٍّ صحّي) وسببُ الرفض — رصيدُ الساعات الشهريّ يُحسب منها |
| `staff_affairs_attendanceexception` | استثناءاتُ التأخير الصباحيّ والخروج المبكر (نموذج 03): المدّةُ والساعةُ ومحتوى الطلب ومرفقُ ما يثبت الحاجة (ملفٌّ قد يكون تقريراً طبيّاً — يُخدَم لصاحبه وللمدير ونائبَيه (الإداريّ والأكاديميّ) وحدَهم — لأنّ أيّاً منهما قد يُكلَّف بأعباء المدير فيقرّر النموذج) ووصفُه الاختياريّ وتغذيةُ المدير الراجعة — سندُ ما لم يُعدّ تأخّراً أو انصرافاً مبكراً |
| `staff_affairs_staffassignment` | تكليفُ موظّفٍ بأعباء وظيفةٍ مؤقّتاً (م-43 من النظام الوظيفيّ): من كُلّف ومن كلّفه والوظيفةُ والمدّةُ والسببُ ومرجعُ القرار، ومن رفعه ومتى — الرفعُ لا يحذف الصفّ، وقراراتُ المكلَّف في التدقيق تشير إلى معرّفه، فيبقى من اعتمد باسم صاحب الوظيفة ومتى |
| `staff_affairs_staffattendanceexemption` | إعفاءُ موظّفٍ من الرصد اليوميّ للحضور (ق-16): من أُعفي ومن أعفاه والمدّةُ ومرجعُ القرار، ومن رفعه ومتى — لا سببَ يُخزَّن عمداً (بيانةٌ صحّيّةٌ محتملة)؛ الرفعُ لا يحذف الصفّ |
...
| `core_exportjob` | تصديرُ الجدول (PDF/Excel) الخلفيّ (P4-6، البند 5) — الصفُّ كلُّه يُحذف بعد 24 ساعةً من `created_at` (كلُّ الحالات) بمهمّةٍ **كلَّ ساعة** (`operations.purge_expired_export_jobs`، `tests/test_export_core.py`: صفٌّ عمرُه 25 ساعةً يُحذف بعد أوّل تشغيل) لا بقاعدة §2 العامّة؛ التنزيلُ يقع خلال دقائق من طلبه فلا حاجةَ لمدّةٍ أطول. وخطأُ التصدير يُخزَّن **رمزاً ثابتاً** (`timeout`/`too_large`/`failed`/`forbidden`) لا نصَّ استثناءٍ (قد يحمل قيماً شخصيّة). |
