...
| `staff_affairs_attendanceexception` | استثناءاتُ التأخير الصباحيّ والخروج المبكر (نموذج 03): المدّةُ والساعةُ ومحتوى الطلب ووصفُ ما يثبت الحاجة (نصٌّ حرٌّ قصير، والأصلُ الورقيُّ لدى الإدارة) وتغذيةُ المدير الراجعة — سندُ ما لم يُعدّ تأخّراً أو انصرافاً مبكراً |
| `staff_affairs_principaldelegation` | إنابةُ المدير نائبَ الشؤون الإدارية ليومٍ (03_job_descriptions_rbac.md:401) — من اعتمد باسم المدير ومتى |
