...
`core_exportjob`) — محتواه لا يُبثّ مباشرةً في الردّ بل يُخزَّن حتى يجهز، فيُحذف خلال 24
ساعة بمهمّته الخاصّة لا بقاعدة N-يوم هنا. وما سواه من تصديرٍ (Excel/PDF مباشر في مسارات
...
| `core_exportjob` | تصديرُ الجدول (PDF/Excel) الخلفيّ (P4-6، البند 5) — محتواه يُحذف خلال 24 ساعة بمهمّةٍ يوميّةٍ مستقلّة (`operations.purge_expired_export_jobs`) لا بقاعدة §2 العامّة؛ التنزيلُ يقع خلال دقائق من طلبه فلا حاجةَ لمدّةٍ أطول. |
