...
وأُعيد ترقيمُها من `0064` إلى `0065`: أخذ `main` الرقمَ نفسَه في `0064_wing_coverage`
بينما كان هذا الفرعُ يعمل — وهجرتان برقمٍ واحدٍ وأصلٍ واحد تفرّعان الرسمَ فيرفض جانغو.
"""
