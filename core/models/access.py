...
class Role(models.Model):
    ROLES = [
        ...
        # مرافقُ الدعم ليس مساعدَ معلّم. كان `import_staff_register` يحمله على
        # `ese_assistant`، وسياسةُ الدعم التعليميّ الإضافيّ تفرّق بينهما نصّاً:
        # مرافقُ الدعم من «الكادر الإضافيّ الذين **لا يملكون مؤهّلاتٍ رسميّةً أو
        # خبرةً في مجال التعليم**» (ص155)، ومهامُّه رعايةٌ شخصيّةٌ وسلامة —
        # التنقّلُ والطعامُ ودورةُ المياه والدعمُ الجسديّ — «حسب توجيه أحد أعضاء
        # الكادر التعليميّ أو الإداريّ» (ص161-163). بينما «المعلّم المساعد»
        # تربويٌّ يتبع خطّةً موضوعة، وإن كان «غيرَ مسؤولٍ عن التخطيط» (ص129).
        # ودمجُهما يفتح لمرافقٍ شاشاتِ مساعدِ معلّمٍ يرثها عن معلّم التربية الخاصّة.
