...
def registry() -> dict[str, Capability]:
    ...
    caps = [
        ...
        _cap(
            ...
            {"principal", "vice_admin", "vice_academic", "coordinator", "secretary"},
            scope=(
                "الطلباتُ في مربّع المستخدم وحدَها: منسّقُ القسم لمعلّميه، والنائبُ لمن يتبعه، "
                "والسكرتاريةُ للرصيد، والمديرُ للاعتماد ولنموذج 03 — ونائبُ الشؤون الإدارية "
                "في مربّع المدير يومَ يُنيبه المدير"
            ),
            basis=(
                "نموذج 02 (أصل PDF ص1، 07_forms_catalog.md:13، 07b:13): المسؤول المباشر ← "
                "النائب المسؤول (rbac_roles.json reports_to) ← السكرتارية ← الإدارة؛ ومنسّقُ "
                "المادة مسؤولُ المعلّم المباشر (06_attendance_performance_review.md:33، "
                "03_job_descriptions_rbac.md:374)؛ ونموذج 03 «استخدام مدير المدرسة» (07:14)؛ "
                "والإنابةُ «عن المدير في مهامه في حال غيابه» (03:401، "
