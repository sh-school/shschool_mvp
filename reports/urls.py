...
urlpatterns = [
    ...
    path("view/", views.report_viewer, name="report_viewer"),
    path("class/<uuid:class_id>/results/", views.class_results_pdf, name="class_results_pdf"),
    path(
        "class/<uuid:class_id>/certificates/",
        views.class_certificates_pdf,
        name="class_certificates_pdf",
    ),
    path(
        "class/<uuid:class_id>/attendance/",
    ...
    path(
        "class/<uuid:class_id>/results/excel/",
        views.class_results_excel,
        name="class_results_excel",
    ),
    path(
        "class/<uuid:class_id>/attendance/excel/", views.attendance_excel, name="attendance_excel"
    ),
