...
from core.models import CustomUser, StudentEnrollment, ClassGroup
from core.pdf_utils import render_pdf

from .services import ReportDataService, ExcelService
...
def class_results_excel(request, class_id):
    ...
    return ExcelService.class_results_excel(
        class_grp, school, request.GET.get("year", "2025-2026")
    )
...
def behavior_excel(request):
    ...
    return ExcelService.behavior_excel(
        school, request.GET.get("year", "2025-2026")
    )
