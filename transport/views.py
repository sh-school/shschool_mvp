...
from core.models import CustomUser, SchoolBus, BusRoute, School
from core.permissions import bus_supervisor_required, staff_required
...
def transport_dashboard(request):
    ...
    total_students = CustomUser.objects.filter(
        bus_routes__bus__school=school
    ).distinct().count()
