...
urlpatterns = [
    ...
    path("setup/<uuid:setup_id>/export/", views.export_gradebook, name="export_gradebook"),
    path("setup/<uuid:setup_id>/recalculate/", views.recalculate_class, name="recalculate_class"),
    ...
    path(
        "assessment/<uuid:assessment_id>/save-single/",
        views.save_single_grade,
        name="save_single_grade",
    ),
    path(
        "assessment/<uuid:assessment_id>/save-all/", views.save_all_grades, name="save_all_grades"
    ),
