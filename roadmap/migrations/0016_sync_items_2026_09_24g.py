"""مزامنةُ الخارطة السابعة يومَ 2026-09-24: اعتمادُ الجدول الجديد وقياسُ مؤشّراته، و#555، وثلاثةَ عشرَ ديناً مفتوحاً.
...
- **N-035 ← #555** (أيقونةُ حوار التأكيد المكسورة).
- **ثلاثةَ عشرَ ديناً مفتوحاً** (DBT-40..52): أربعةٌ لمداخل الرفع بلا clean_photo (تحقّقتُ منها) من جلسة «اصلاحات 02»، وثمانيةٌ
  من جلسة «Styleguide» (بطلب المالك «كلها»؛ تقديراتُها مقترحةٌ ولم أتحقّق منها كلَّها)، وثلاثةٌ من جلسة الأيقونة وما وجدتُه
  (تحقّقتُ من تكرار صفّي الوثيقة، ومن iconSvg، ومن عدد شبكات Docker).
...
OPEN_DEBTS_FIRST_ORDER = 471  # بعد N-035 (470)
