...
- **D-19** قرارٌ جديدٌ يُنشأ محسوماً بتاريخه: «الجدولُ المعتمد ممتلئٌ فالتعويضُ في حصّة زميلٍ بموافقته» — اختاره المالكُ في
  جلسة «اصلاحات 01» وأكّده لي في محادثة الخارطة («نعم»).
...
لا تحسم قراراً مفتوحاً، ولا تُدرج ما لم يندمج طلبُه (#548 وبنودُ الجدول، #545 #551 #552 #553).
"""
...
NEW_ITEMS = [
    (
        ...
        "المفتوحة، وتنبيهُ الإجازة). قرارُ المالك D-19 (2026-09-24، أكّده هنا): الجدولُ المعتمد ممتلئٌ (0 خانة فارغة من 863) فلا حصّةَ فارغةً يُعوَّض فيها، فالتعويضُ في حصّة زميلٍ يدرّس الشعبة بموافقته ثمّ اعتماد المنسّق. "
...
NEW_DECISIONS = [
    {
        "code": "D-19",
        "src": "OWN",
        "title": "التعويضُ عن الحصّة الغائبة: في حصّةٍ فارغة، أم في حصّة زميلٍ يدرّس الشعبة بموافقته؟",
        "status": "decided",
        "decider": "المالك",
        "due": "2026-09-24",
        "decision_date": DAY,
        "blocks": "N-033",
        "options": "(أ) في حصّةٍ فارغةٍ من الجدول. (ب) في حصّة زميلٍ يدرّس الشعبة بموافقته ثمّ اعتماد المنسّق.",
        "recommendation": f"{STAMP} حسمُ المالك: (ب) — الجدولُ المعتمد ممتلئٌ (0 خانة فارغة من 863) فلا حصّةَ فارغةً "
        "يُعوَّض فيها. اختاره في جلسة «اصلاحات 01» وأكّده لجلسة الخارطة. نُفّذ بـ#546.",
        "sort_order": 117,  # بعد D-18 (116)
    },
]
