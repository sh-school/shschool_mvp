...
class Migration(migrations.Migration):
    dependencies = [
        ('notifications', '0002_rename_notif_school_type_idx_notificatio_school__75db48_idx_and_more'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                    related_name='push_subscriptions', to='core.school')),
            ],
            options={'verbose_name': 'اشتراك Push', 'verbose_name_plural': 'اشتراكات Push',
                     'ordering': ['-created_at']},
        ),
    ]
