...
class TestEmployeeEvaluation:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # (89×50 + 90×50) / 100 = 89.5 → جيد جداً لا ممتاز، ويُعرض 89: الرقمُ داخل
            # نطاق مستواه المطبوع «جيد جداً (89–76)» (`total_for`، ADR-0002 §6.2).
            (((89, 50), (90, 50)), 89, "very_good"),
            # 75.3 → جيد جداً، ويُعرض 76 لا 75 (75 في نطاق «جيد (75–66)»).
            (((75, 70), (76, 30)), 76, "very_good"),
            # 49.5 → ضعيف، ويُعرض 49 لا 50 (50 في نطاق «مقبول (65–50)»).
            (((49, 50), (50, 50)), 49, "weak"),
        ],
    )
