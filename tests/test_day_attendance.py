...
**ولكنّ السريانَ ليس تخفيفاً**: `absence_standing` يحكم اليومَ بالمادة 3.4.3
(أربعُ خاناتٍ حضوراً على الأقلّ)، ويومٌ رصدُه ناقصٌ لا يُحسم. فرصدُ الحصّة
الأولى وحدَها يترك الغائبَ يوماً كاملاً «لم يُحسم» لا يبلغ عتبةَ استدعاءٍ ولا
حرمان.
