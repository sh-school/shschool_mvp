...
# و`/.local/`: حزمٌ ثبّتها pip داخل حاوية جلسةٍ فكتبها في شجرة العمل المربوطة —
# آلافُ الملفّات تُقرأ عبر ربط ويندوز فيطول الفحصُ دقائق، وليست شيفرتَنا.
_PY_SKIP = ("/.venv/", "/.local/", "/node_modules/", "/worktrees/", "/migrations/", "/tests/")
