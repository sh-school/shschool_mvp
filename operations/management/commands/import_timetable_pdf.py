...
TEACHER_MAP = {
    ...
    # مُدرَّسان جديدان هذا العام: أُدخلا مؤقّتاً باسميهما المختصرين ثمّ
    # اكتملت بياناتهما، فصار اسمُ المنصّة رباعياً ولا يطابق الجدول.
    "جمال صالح": "جمال صالح محمد ادم",
    "علي الطيطي": "علي صالح اسماعيل الطيطي",
