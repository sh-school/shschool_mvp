...
class ScheduleRetentionMixin:
    ...
    def retain_archived_generations(
        ...
        كان الافتراضُ صفراً (2026-09-05)، وصار نسختين (SCH-07، 2026-09-24): السابقُ
        للتراجع والذي قبله للمقارنة، وما زاد يذهب عند الاعتماد التالي. والمسودّاتُ والفاشلُ خارجَ هذا كلِّه — الأولى
