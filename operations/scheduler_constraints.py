...
#: وفي كلّ إزاحةٍ بعمقٍ ثلاث، وفي كلّ محاولةٍ من الثماني. قِيست: 3,495
#: استعلاماً في توليدٍ واحد، 8.3 ثانيةً من 22.5 محلّيّاً — والجرسُ لا
#: يتغيّر في أثناء التوليد. فيُقرأ مرّةً عند بدئه ويُنسى عند انتهائه.
#:
