...
HARD_CONSTRAINTS = (
    ...
    #: العنوانُ يُقرأ في صفحة الاعتماد: التلاصقُ المسموحُ صفر (`MAX_CONSECUTIVE = 1`) إلّا للضرورة، وما يفصله فسحةٌ أو صلاةٌ لا يُعدّ.
    _hard("HC5", "معلّمٌ يقف حصّتين متّصلتين بلا استراحة", break_at=RELAXED, relaxes_in_place=True),
    ...
    _hard(
        "HC6",
        "المادّةُ تُوزَّع على الأيّام بالقسمة",
        tunable=False,
