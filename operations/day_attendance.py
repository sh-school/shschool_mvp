...
في [`absence_standing`](absence_standing.py) يُحكم اليومُ بالمادة 3.4.3: حضر
أربعَ خاناتٍ فأكثر فيومُ حضور، وأقلَّ فيومُ غياب — **ويومٌ رصدُه ناقصٌ لا يُحسم**:
إن كان ما حضره مع الخانات غير المرصودة يبلغ الأربع عُرض ولم يُحتسب. فلو رُصدت
الحصّةُ الأولى وحدَها لبقي الغائبُ يوماً كاملاً «لم يُحسم» لا يبلغ عتبةَ استدعاءٍ
ولا حرمان — والسياسةُ تعدّ **أيّامَ تمدرس** لا حصصاً، وهذه القاعدةُ هي الجسر.
...
وأثرُ ذلك في الاحتساب محفوظ: `absence_standing` يعدّ **الخانات** لا الحصص،
فحصّتا الزوج خانةٌ واحدة.
