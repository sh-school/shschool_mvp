...
from core.models import School, CustomUser, ClassGroup
...
class Session(models.Model):
    ...
    teacher     = models.ForeignKey(CustomUser,  on_delete=models.CASCADE, related_name="sessions",
                                    verbose_name="المعلم")
...
class ScheduleSlot(models.Model):
    ...
    class_group   = models.ForeignKey(ClassGroup,  on_delete=models.CASCADE, related_name="schedule_slots")
    subject       = models.ForeignKey(Subject,     on_delete=models.SET_NULL, null=True, blank=True)
...
class TeacherAbsence(models.Model):
    ...
    teacher     = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="absences_as_teacher")
...
class SubstituteAssignment(models.Model):
    ...
    id            = models.UUIDField(primary_key=True, default=_uuid, editable=False)
    absence       = models.ForeignKey(TeacherAbsence, on_delete=models.CASCADE, related_name="assignments")
    slot          = models.ForeignKey(ScheduleSlot,   on_delete=models.CASCADE, related_name="substitute_assignments")
    substitute    = models.ForeignKey(CustomUser,     on_delete=models.CASCADE, related_name="substitute_assignments")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["slot", "absence"],
                name="one_substitute_per_slot_absence"
            )
        ]
        ordering = ["-created_at"]
