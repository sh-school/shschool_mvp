...
urlpatterns = [
    ...
    path(
        "notification-preferences/", views.NotificationPreferencesView.as_view(), name="notif-prefs"
    ),
    # ── KPIs ──────────────────────────────────────────────────────
    ...
    path(
        "parent/children/<uuid:student_id>/grades/",
        views.parent_child_grades,
    ...
    path(
        "erasure/requests/<uuid:request_id>/",
        views_erasure.erasure_request_detail,
        name="erasure-detail",
    ),
    path(
        "erasure/requests/<uuid:request_id>/approve/",
        views_erasure.approve_erasure,
        name="erasure-approve",
    ),
    path(
        "erasure/requests/<uuid:request_id>/reject/",
        views_erasure.reject_erasure,
        name="erasure-reject",
    ),
]
