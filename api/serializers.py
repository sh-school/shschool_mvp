...
from core.models import (
    School, CustomUser, ClassGroup, StudentEnrollment, ParentStudentLink,
)
...
class ClassGroupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = ClassGroup
        fields = [
            "id", "grade", "grade_display", "section", "level_type",
            "level_display", "academic_year", "student_count",
        ]
...
class SessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Session
        fields = [
            "id", "class_group_name", "subject_name",
...
class AttendanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "student_id", "student_name", "national_id",
            "status", "status_display", "excuse_type", "marked_at",
        ]
...
class AnnualSubjectResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "subject_name", "academic_year",
            "s1_result", "s2_result", "annual_total",
            "status", "status_label", "letter_grade",
        ]
...
class BehaviorInfractionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "student_name", "national_id",
            "level", "level_label", "description",
            "points_deducted", "reported_by", "date", "is_resolved",
        ]
...
class InAppNotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "title", "body", "event_type", "event_label",
            "priority", "priority_label", "related_url",
...
class UserNotificationPreferenceSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            "event_channels", "quiet_hours_start", "quiet_hours_end",
        ]
...
class ParentStudentLinkSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "student", "relationship", "relationship_label",
            "can_view_grades", "can_view_attendance", "class_name",
        ]
...
class ClinicVisitSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = ClinicVisit
        fields = [
            "id", "student_name", "nurse_name", "visit_date",
            "reason", "diagnosis", "is_sent_home", "parent_notified",
        ]
...
class LibraryBookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "book_type", "type_label", "quantity", "available_qty",
        ]
...
class BookBorrowingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = BookBorrowing
        fields = [
            "id", "book_title", "user_name", "borrow_date",
            "due_date", "return_date", "status", "status_label", "is_overdue",
        ]

    def get_is_overdue(self, obj):
        from datetime import date
        return (
            obj.status == "BORROWED" and
            obj.due_date and
